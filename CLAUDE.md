...
| `plans/optimization-opportunities.md` | 22 catalogued inference-path optimisation opportunities (SIMD gaps, per-frame allocations, algorithmic redundancy, cache patterns, Python overhead), each with file/line references, impact rating, and suggested fix. Read this before starting any performance work. |
